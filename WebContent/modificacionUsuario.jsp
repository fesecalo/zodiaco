...
<% 
		...
		if (request.getAttribute("usuarioAModificar") != null) {
			user = (Usuario) request.getAttribute("usuarioAModificar");
					...
					<h5 class="card-title">Buscar usuario a modificar</h5>
						<form action="listarMod" method="post">
							<div class="form-group">
								<label for="nombre">Nombre usuario completo</label> <input type="text"
									class="form-control" name="nombre"
									placeholder="Nombre completo del usuario que quiere modificar">
							</div>
						...
						<input type="hidden" name="id_user" value="<%= user.getId_user() %>">
							...
							<div class="form-group">
								<label for="usuario">Usuario</label> <input type="text"
									class="form-control" name="usuario" value="<%=user.getUsuario() %>">
							</div>
							<div class="form-group">
								<label for="fechaNac">Fecha de nacimiento</label> <input
									type="text" class="form-control" name="fechaNac" value="<%=fechaNacimiento%>">
							</div>
							<div class="form-group">
								<label for="correo">Correo</label> <input type="email"
									class="form-control" name="correo" value="<%=user.getMail()%>">
							</div>
							
							<div class="form-group">
								<label for="correo">Password</label> <input type="password"
